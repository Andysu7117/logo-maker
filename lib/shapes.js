...
class Triangle extends Shape {
  ...
  <text x="${halfSide}" y="100" font-size="60" text-anchor="middle" fill="${this.textColour}">${this.text}</text>
</svg>`;
  }
}
...
class Square extends Shape {
  ...
  <text x="80" y="80" font-size="60" text-anchor="middle" fill="${this.textColour}">${this.text}</text>
</svg>`;
  }
}
